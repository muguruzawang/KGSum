...
from module.GATLayer import PositionwiseFeedForward, WSGATLayer, SWGATLayer, ESGATLayer, SEGATLayer
...
class WSWGAT(nn.Module):
    ...
    def forward(self, g, w, s):
        ...
        h = F.elu(self.layer(g, neighbor)) ##使用elu作为激活函数
        h = h + origin  ###残差连接
