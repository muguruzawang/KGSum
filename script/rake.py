...
class Rake(object):
    ...
    def get_word_score(self,word):
        #print(self.degree[word])
        #print(self.frequency_dist[word])
        return self.degree[word] / self.frequency_dist[word]
    ...
    def _get_phrase_list_from_words(self, word_list):
        ...
        """
        groups = groupby(word_list, lambda x: x not in self.to_ignore and len(x)>1)
